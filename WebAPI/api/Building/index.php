...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // POST request received at https://swiftbook.co/api/Building
    ...
    // https://swiftbook.co/api/Building
    try {
    ...
    // https://swiftbook.co/api/Building/0
    try {
    ...
    // GET request received with Buildingname
    // https://swiftbook.co/api/Building/ByBuildingname/brianjmorris
    try {
        // Construct SELECT query with id
        $stmtString = "SELECT * FROM " . $tablename
