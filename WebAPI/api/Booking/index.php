...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // POST request received at https://swiftbook.co/api/Booking
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            // set location header pointing to new booking
            header("Location: /api/Booking/" + $new_id);
    ...
    // https://swiftbook.co/api/Booking
    try {
    ...
    // https://swiftbook.co/api/Booking/0
    try {
    ...
    // GET request received with Bookingname
    // https://swiftbook.co/api/Booking/ByBookingname/brianjmorris
    try {
        // Construct SELECT query with id
        $stmtString = "SELECT * FROM " . $tablename
